...
public class BookPurchaseServiceFailTest extends DatabaseSuite {
  ...
  @Test
  void shouldSendFailMessageToKafkaE2ETest() throws JsonProcessingException, InterruptedException {
    var uuid = UUID.randomUUID().toString();

    bookService.setAccountMoney(0L);
    ...
    records
        ...
        .forEachRemaining(
            record -> {
              ...
              assertEquals(message.message(), "Not enough money on the account");
            });
  }
